...
return message.channel.send(new Discord.MessageEmbed().setColor('#00ff51').setDescription(`**\`${args[0]}\`** **Adet Mesajı Başarıyla Sildim...** <a:beyaztik:780065069136478208>`)).then(m => m.delete({timeout: 5000}))
