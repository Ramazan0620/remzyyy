...
.setColor('#00ff51')
.setDescription(`<a:remzybasarili:799627754228023366> Kayıt Olunca Alınacak Rol Sıfırlandı ! `)
...
.setColor('#ff0000')
.setDescription(`<a:remzybasarisiz:799626534993526795> Kayıt Olunca Alınacak Rolü Belirtiniz ! `)
.setFooter(`Komut ${message.author.tag} Tarafından Kullanıldı ! `)
...
.setColor('#00ff51')
.setDescription(`<a:remzybasarili:799627754228023366> Kayıt Olunca Otomatik Alınacak Rol Başarıyla ${rol} Olarak Ayarlandı ! `)
.setFooter(`Komut ${message.author.tag} Tarafından Kullanıldı ! `)
